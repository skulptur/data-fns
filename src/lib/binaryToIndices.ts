 ...
 *
 * @complexity This function has a time complexity of O(n), where n is the length of the input array, and
 * a space complexity of O(m), where m is the number of 1s in the input array.
 */
